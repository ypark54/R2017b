...
SIMULINK_EXPORT_EXTERN_C uint8_T ssMessageSend(SimStruct *S, int outputPortIdx, const void *payload, unsigned int priority);
SIMULINK_EXPORT_EXTERN_C uint8_T ssMessageSendToLocalQueue(SimStruct *S, int pIdx, const void *payload, unsigned int priority);
SIMULINK_EXPORT_EXTERN_C int_T ssGetNumMessagesInOutputQueue(SimStruct *S, int pIdx);

SIMULINK_EXPORT_EXTERN_C uint8_T ssMessageRelay(SimStruct *S, int outputPortIdx, ssMessage msgObj);
...
SIMULINK_EXPORT_EXTERN_C uint8_T ssMessageQueuePush(SimStruct *S, ssMessageQueueLocationType qt, int queueID, ssMessage msg);

SIMULINK_EXPORT_EXTERN_C ssMessage ssMessageQueuePop(SimStruct *S, ssMessageQueueLocationType qt, int queueID, uint8_T* isOverflowed);

SIMULINK_EXPORT_EXTERN_C ssMessage ssMessageQueuePopForDesCharts(SimStruct *S, ssMessageQueueLocationType qt, int queueID, bool isMsgTrigger, uint8_T* isOverflowed);
