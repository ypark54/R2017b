...
mUnit;}NeEquationData;typedef struct NeVariableDataTag{const char *mFullPath;
size_t mIndex;NeDsVariableFlag mFlags;const char *mObject;real_T mScale;const
char *mUnit;real_T mICValue;boolean_T mIsDifferential;size_t mM;size_t mN;
NeInitMode mInitMode;const char *mDescription;}NeVariableData;typedef struct
NeObservableDataTag{const char *mFullPath;const char *mObject;size_t mM;size_t
mN;const char *mUnit;real_T mNominalValue;const char *mNominalUnit;
NeNominalSource mNominalSource;NeInitMode mInitMode;boolean_T mIsDetermined;
boolean_T mIsDifferential;boolean_T mIsFrequency;const char *mDescription;}
NeObservableData;typedef struct NeModeDataTag{const char *mFullPath;size_t
mIndex;const char *mObject;int32_T mICValue;const char *mDescription;}
...
mNumRanges;size_t mStart;const char *mPath;const char *mDescriptor;NeZcType
mType;}NeZCData;typedef struct NeAssertDataTag{const char *mObject;size_t
mNumRanges;size_t mStart;const char *mPath;const char *mDescriptor;boolean_T
mIsWarn;const char *mMessage;const char *mMessageID;}NeAssertData;typedef
struct NeParameterDataTag{const char *mFullPath;const char *mObject;const char
*mDescription;size_t mIndex;size_t mM;size_t mN;}NeParameterData;
#ifdef __cplusplus
}
#endif /* __cplusplus */
#include "pm_inline.h"
...
NE_GENERAL_EQ_FLAG= 1<<3,NE_ACROSS_EQ_FLAG= 1<<4,NE_THROUGH_EQ_FLAG= 1<<5,
NE_NO_EQ_FLAGS= 0};enum{NE_NODAL_VAR_FLAG= 1<<0,NE_OUTPUT_VAR_FLAG= 1<<1,
NE_INPUT_VAR_FLAG= 1<<2,NE_SIGNAL_VAR_FLAG= 1<<3,NE_NO_VAR_FLAGS= 0};typedef
union NeDsMethodOutputTag{PmSparsityPattern mM_P;PmRealVector mM;PmBoolVector
mVMM;PmSparsityPattern mDXM_P;PmRealVector mDXM;PmSparsityPattern mDUM_P;
PmRealVector mDUM;PmSparsityPattern mDTM_P;PmRealVector mDTM;PmSparsityPattern
mA_P;PmRealVector mA;PmSparsityPattern mB_P;PmRealVector mB;PmSparsityPattern
mC_P;PmRealVector mC;PmRealVector mF;PmBoolVector mVMF;PmBoolVector mSLF;
...
mTDUF_P;PmSparsityPattern mTDXF_P;PmSparsityPattern mDNF_P;PmRealVector mDNF;
PmBoolVector mDNF_V_X;PmRealVector mIC;PmRealVector mICR;PmIntVector mICR_IM;
PmBoolVector mICR_ID;PmRealVector mDXICR;PmSparsityPattern mDXICR_P;
PmSparsityPattern mTDUICR_P;PmSparsityPattern mMDUY_P;PmSparsityPattern mMDXY_P
...
mUPDATE_R;PmIntVector mUPDATE_I;PmRealVector mSFO;PmRealVector mSFP;
PmRealVector mINIT_R;PmIntVector mINIT_I;PmRealVector mLOG;PmIntVector mASSERT
;PmIntVector mPASSERT;PmRealVector mDEL_T;PmRealVector mDEL_V;PmRealVector
mDEL_V0;PmRealVector mDEL_TMAX;PmSparsityPattern mDXDELT_P;PmRealVector mDXDELT
...
mOBS_ALL;PmIntVector mDP_L;PmIntVector mDP_I;PmIntVector mDP_J;PmRealVector
mDP_R;PmRealVector mQX;PmRealVector mQU;PmRealVector mQT;PmRealVector mQ1;
PmSparsityPattern mQX_P;PmSparsityPattern mQU_P;PmSparsityPattern mQT_P;
PmSparsityPattern mQ1_P;PmRealVector mVAR_TOL;PmRealVector mEQ_TOL;
PmBoolVector mLV;PmBoolVector mSLV;}NeDsMethodOutput;typedef enum
NeDsMethodIdTag{NE_INVALID_METHOD_ID= -1,NE_DS_METHOD_M_P,NE_DS_METHOD_M,
NE_DS_METHOD_VMM,NE_DS_METHOD_DXM_P,NE_DS_METHOD_DXM,NE_DS_METHOD_DUM_P,
NE_DS_METHOD_DUM,NE_DS_METHOD_DTM_P,NE_DS_METHOD_DTM,NE_DS_METHOD_A_P,
NE_DS_METHOD_A,NE_DS_METHOD_B_P,NE_DS_METHOD_B,NE_DS_METHOD_C_P,NE_DS_METHOD_C
,NE_DS_METHOD_F,NE_DS_METHOD_VMF,NE_DS_METHOD_SLF,NE_DS_METHOD_SLF0,
...
NE_DS_METHOD_ICR_ID,NE_DS_METHOD_DXICR,NE_DS_METHOD_DXICR_P,
NE_DS_METHOD_TDUICR_P,NE_DS_METHOD_MDUY_P,NE_DS_METHOD_MDXY_P,
...
NE_DS_METHOD_LOG,NE_DS_METHOD_ASSERT,NE_DS_METHOD_PASSERT,NE_DS_METHOD_DEL_T,
...
NE_DS_METHOD_DP_L,NE_DS_METHOD_DP_I,NE_DS_METHOD_DP_J,NE_DS_METHOD_DP_R,
NE_DS_METHOD_QX,NE_DS_METHOD_QU,NE_DS_METHOD_QT,NE_DS_METHOD_Q1,
NE_DS_METHOD_QX_P,NE_DS_METHOD_QU_P,NE_DS_METHOD_QT_P,NE_DS_METHOD_Q1_P,
NE_DS_METHOD_VAR_TOL,NE_DS_METHOD_EQ_TOL,NE_DS_METHOD_LV,NE_DS_METHOD_SLV,
...
NeDynamicSystem *(*NeDsCreateDsFcn)(const NeDynamicSystem *);typedef void(*
NeDsExpandFcn)(const NeDynamicSystem *,const NeDynamicSystemInput *,
PmRealVector *);struct NeDynamicSystemTag{size_t mNumIo[NUM_IO_TYPES];const
NeDsIoInfo *mIo[NUM_IO_TYPES];size_t mNumVariables;size_t
mNumDiscreteRealVariables;size_t mNumDifferentialVariables;size_t mNumEquations
;size_t mNumICResiduals;size_t mNumModes;size_t mNumMajorModes;size_t
...
mNumRanges;size_t mNumEquationRanges;size_t mNumFundamentalSamples;size_t
...
NeRange *mAssertRanges;NeAssertData *mParamAssertData;NeRange *
mParamAssertRanges;NeRange *mRanges;NeRange *mEquationRanges;NeParameterData *
mLogicalParameters;NeParameterData *mIntegerParameters;NeParameterData *
mIndexParameters;NeParameterData *mRealParameters;void *mLargeArrayData;
NeDsGenerateFcn mGenerateFcn;NeDsCreateDsFcn mDiagnosticsDsFcn;NeDsExpandFcn
mExpandFcn;NeChecksum mChecksum;};PMF_DEPLOY_STATIC void
...
NE_EQ_DDF_P,NE_EQ_DDF,NE_EQ_TDF_P,NE_EQ_NUM}NeEqMethodId;typedef union
...
*mDEL_TMAX;real_T *mDDELT;int32_T *mDDELT_P;}NeEqGroupMethodOutput;typedef
union NeEqMethodParamOutputTag{real_T *mC1;}NeEqParamMethodOutput;typedef union
NeEqMethodOutputTag{real_T mM;int32_T *mDM_P;real_T *mDM;real_T mF;boolean_T
mVMF;boolean_T mSLF;boolean_T mVMM;int32_T *mDF_P;real_T *mDF;int32_T *mDDF_P;
real_T *mDDF;int32_T *mTDF_P;}NeEqMethodOutput;typedef struct
NeEqMethodInputTag NeEqMethodInput;typedef struct NeElementEquationGroupInfoTag
NeElementEquationGroupInfo;typedef void *(*NeEqSetupFcn)(const
NeElementEquationGroupInfo *);typedef void(*NeEqCleanupFcn)(void *);typedef
void(*NeEqParamMethod)(const void *,NeEqParamMethodOutput *);typedef void(*
NeEqMethod)(const NeEqMethodInput *,NeEqMethodOutput *);struct
NeEqMethodInputTag{real_T *mX;int32_T *mM;int32_T *mQ;real_T *mW;void *mEqData
;};
#ifdef __cplusplus
}
#endif /* __cplusplus */
